...
relatert til:
---
Det siste året har jeg levd med en ["dum smarttelefon"](https://simenskriver.no/dum-ned-smarttelefonen). Og det har i grunn vært fint det altså. Skjermtida mi har vel vært rundt 2,5 timer om dagen, sånn omtrent. Ikke at jeg er stolt av det nødvendigvis, men jeg veit også at det er mindre enn mange.
...
Tidligere har jeg snakka om dette med å [ta vare på oppmerksomheten din](https://simenskriver.no/oppmerksomhet), og hvordan det å skru av internettet på dataen kan frigjøre mental kapasitet når du skal jobbe:

> Det er alle mulighetene som gjør det vanskelig å fokusere på det du _egentlig_ tenkte å gjøre. ==Alle mulighetene for underholdning, for å kommunisere med andre, for å planlegge noe på privaten, for å researche noe.== Om du skrur av internettet så kan du ikke lenger sende den meldinga på Messenger, du kan ikke kjapt sjekke prisen på den tingen på Finn, eller spørre ChatGPT om å utdype en tanke for deg. Og i blant er det nøyaktig den frarøvelsen av muligheter du trenger.
...
![[Pasted image 20250803091159.png|400]]

![[Pasted image 20250803091207.png|400]]
Du må ikke bruke den appen for å blokkere nettleseren altså, som utvikleren av Dumb Phone-appen, Michael Tigas, [også viser her i framgangsmåten](https://dumbphone.so/blog/how-to-block-safari-on-iphone) for hvordan du blokkerer nettleseren.
