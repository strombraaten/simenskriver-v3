...
I det siste har jeg gått over til en kjedelig smarttelefon-løsning. Mer konkret å bruke [en smarttelefon som heter Jelly Star](https://www.unihertz.com/products/jelly-star?variant=44179567968495), fra et selskap som heter Unihertz.

![[images/jelly-star.jpg]]
...
Under kan du se et eksempel fra månedskortet mitt hos Ruter, og en deilig låt som heter [Nevada, fra Kerala Dust](https://tidal.com/track/141126156/u). 

![[images/jelly-star-eksempler.jpg]]
...
![[images/jelly-star-unboxing.jpg]]
...
![[images/jelly-star-before-after.webp]]

For å komme dit har jeg:
- Gjort skjermen svart-hvitt, [[dum-ned-smarttelefonen|på samme måte som med iphonen min tidligere]]
- For å forenkle hjemskjermen bruker jeg [Niagara launcher](https://niagaralauncher.com/)
	- For øyeblikket er det disse appene jeg har på hjemskjermen: [1password](https://1password.com/), Telefon, [Beeper](https://www.beeper.com/) (kommer tilbake til den), [Snipd](https://www.snipd.com/) (podkast), Google kalender, [Tidal](https://tidal.com/), og [Synology Photos](https://www.synology.com/en-global/dsm/feature/photos) (kommer tilbake til den og)
...
- Begynt å bruke ["swipe typing"](https://www.youtube.com/watch?v=0wMk0S-6CEc) for å skrive fortere, og med mer presisjon (bokstavene er temmelig små)
...
![[images/telefon-daglig-bruk.webp]]
...
For å kunne bruke begge telefonene måtte jeg altså ha et [tvilling Sim-kort](https://www.telia.no/mobilabonnement/sim-kort/ekstra-sim/). Hvis du ikke har planer om det, men hopper hodestups inn i Jelly Star-verden som hovedtelefon (som du fint kan gjøre) trenger du ikke tenke på det jeg skal si nå.
...
1. Det skilles mellom "hoved sim-kort" og "tvilling sim-kort"
2. Bildemeldinger (MMS), og lange SMSer (over 140 tegn ca) kan kun sendes og mottas på telefonen med hoved sim-kort
3. Telefonen som har tvillingkortet vil også få et såkalt "skyggenummer", som er unormalt langt (12 tall i stedet for 8 som du er vant til)
4. Hvis du ringer noen fra telefonen med tvillingkort vil mottageren se hovednummeret ditt (altså ditt vanlige telefonnummer)
5. Om du sender en bildemelding fra telefonen med tvillingkortet vil mottageren se ditt 12-sifra skyggenummer (som ser veldig spæmmete ut)
...
![[images/imessage-innlogging.png]]
...
For å kompensere for å sende meldinger fra dataen eller iPaden har jeg [begynt å bruke Beeper](https://www.beeper.com/). Som er en app som lar deg koble sammen mange meldingstjenester i én. Og som finnes til android/mac/ipad/iphone.

![[images/beeper-eksempel.webp]]
...
Passende nok bestemte akkurat Meta (selskapet som eier Facebook) [å legge ned Messenger-appen på mac (og windows)](https://www.tek.no/nyheter/nyhet/i/VzygRd/meta-legger-ned-messenger-apper-for-mac-og-windows), nå i desember 2025, så da passer det jo godt å teste en ny tilnærming for de av dere som er vant til å bruke den.
...
Prøvde meg på å [[nettside-til-app|gjøre nettsida til en app på macen]], men må fremdeles logge inn hver gang, som sikkert er et smart sikkerhets-grep som er der som standard, men i det daglige blir det litt frustrerende.
